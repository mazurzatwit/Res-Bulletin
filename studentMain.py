...
class mainWindow(QWidget):
        ...
        def __init__(self):
            ...
            self.button1 = QPushButton("Coming Soon...Future Button", self)
            ...
            self.button2 = QPushButton("Coming Soon...Future Button", self)
            ...
            self.button3 = QPushButton("Coming Soon...Future Button", self)
            ...
            self.button4 = QPushButton("Coming Soon...Future Button", self)
